...
from mygraph import GraphProfile
import random
from kivy.core.window import Window
...
class CenterLayout(BoxLayout):
    def __init__(self, **kwargs):
        ...
        voltage_button = Button(text = "Voltage", height = 20, size_hint_y = None, background_normal = '', background_color = rgb("#33B5E5"))
        ...
        current_button = Button(text = "Current", height = 20, size_hint_y = None, background_normal = '', background_color = rgb("#33B5E5"))
        ...
        resistance_button = Button(text = "Resistance", height = 20, size_hint_y = None, background_normal = '', background_color = rgb("#33B5E5"))
        ...
        light_button = Button(text = "Light", height = 20, size_hint_y = None, background_normal = '', background_color = rgb("#33B5E5"))
        ...
        temp_button = Button(text = "Temperature", height = 20, size_hint_y = None, background_normal = '', background_color = rgb("#33B5E5"))
        ...
        dropdown_button = Button(text = "Input Type", size_hint=(0.2, 1), background_normal = '', background_color = rgb("#33B5E5"))
        ...
        remove_button = Button(text = "Delete Recording", size_hint=(0.2, 1), background_normal = '', background_color = rgb("#33B5E5"))
        remove_button.bind(on_press = delete_button)

        settings_button = Button(text = "Settings", size_hint=(0.2, 1), background_normal = '', background_color = rgb("#33B5E5"))
