...
from multiMeterGraph import GraphLayout, GraphProfile
...
def swap_main(self):
	...
	main_layout_top_bar.input_type_button.text = self.graph.graphProfile.title
...
class MutliMeterApp(BoxLayout):
	...
	def	sendDataToQueue(self, *args):
		...
		if nextData:
			...
			self.multimeter_graph.addpoint(nextData["value"])
		return
